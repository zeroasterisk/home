...
# ── Directory listing ─────────────────────────────────────────────────────────
# Use eza when available (modern ls replacement), fall back to ls with flags.
...
# gimme: find files by name pattern under cwd
# gimme-rm: find and delete files by name pattern under cwd
gimme()    { find . -iname "*${1}*"; }
gimme-rm() { find . -iname "*${1}*" -exec rm {} \;; }

# ── Better defaults ───────────────────────────────────────────────────────────
# bat as cat replacement when available
